                        ...
                        <tr class="motorcycle-row" 
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="motorcycles_view.php?id=<?= $moto['id'] ?>" class="action-btn view">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="motorcycles_edit.php?id=<?= $moto['id'] ?>" class="action-btn edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="motorcycles_services.php?id=<?= $moto['id'] ?>" class="action-btn services">
                                        <i class="fas fa-wrench"></i>
                                    </a>
                                    <a href="motorcycles_delete.php?id=<?= $moto['id'] ?>" class="action-btn delete" onclick="return confirmDelete(<?= $moto['id'] ?>, '<?= htmlspecialchars(addslashes($moto['make'] . ' ' . $moto['model'])) ?>')">
        ...
        <div class="motorcycle-grid" id="motorcycleCards">
            ...
            <div class="motorcycle-card fade-in motorcycle-card-item"
                ...
                <div class="moto-actions">
                    <a href="motorcycles_view.php?id=<?= $moto['id'] ?>" class="action-btn view" style="flex: 1;">
                        <i class="fas fa-eye"></i> Просмотр
                    </a>
                    <a href="motorcycles_edit.php?id=<?= $moto['id'] ?>" class="action-btn edit" style="flex: 1;">
                        <i class="fas fa-edit"></i> Изменить
                    </a>
                    <a href="motorcycles_services.php?id=<?= $moto['id'] ?>" class="action-btn services" style="flex: 1;">
                        <i class="fas fa-wrench"></i> Сервис
                    </a>
                </div>
            </div>
            <?php endforeach; ?>
