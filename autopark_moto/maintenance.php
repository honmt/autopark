...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTime() {
        const timeElement = document.querySelector('.table-footer div:last-child');
        if (timeElement) {
            const now = new Date();
...
<!-- Футер -->
<footer style="background: #111; color: #aaa; padding: 20px; text-align: center; border-top: 2px solid #d60000; margin-top: 40px;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <p>© <?php echo date('Y'); ?> AUTOPARK MOTO. Система учета технического обслуживания мотоциклов.</p>
        <p style="font-size: 14px; color: #777; margin-top: 10px;">Телефон: +7 (999) 000-00-00 | Email: info@autopark-moto.ru</p>
    </div>
</footer>
